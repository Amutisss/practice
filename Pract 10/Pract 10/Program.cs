...
namespace Pract_10
{
    class Program
    {
        public static int Rim(String RimNumber)
        {
            int Number = 0;
            int PlusI = 0;
            Number = 0;
            ...
            for (int j = 0; j < RimNumber.Length; j++)
            {
                ...
                {
                    Console.WriteLine("Неккоректно введен символ, значение обнулилось");
        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                Console.WriteLine("Число в десятичной системе счисления: " + Rim(RimNumberFunc));
